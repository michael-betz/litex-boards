...
_io = [
    ...
    # Clock signals are differential, but only the positive sides are named.
    ...
    # 7.2. General Purpose Push Buttons (Active-Low).
    ("gsrn",     0, Pins("G3"),  IOStandard("LVCMOS18")),   # SW6
    ("programn", 0, Pins("C12"), IOStandard("LVCMOS18")),   # SW4
    ("user_btn_n", 0, Pins("G4"),  IOStandard("LVCMOS18")), # SW3
    ("user_btn_n", 1, Pins("G2"),  IOStandard("LVCMOS18")), # SW5
    ("user_btn_n", 2, Pins("J16"), IOStandard("LVCMOS33")), # SW2
    ...
    # 7.3. General Purpose LEDs (Active-Low).
    ("user_led_n", 0, Pins("B3"),  IOStandard("LVCMOS33")), # Bank 2 Green.
    ("user_led_n", 1, Pins("A2"),  IOStandard("LVCMOS33")), # Bank 2 Green.
    ("user_led_n", 2, Pins("H16"), IOStandard("LVCMOS33")), # Bank 2 Green.
    ("user_led_n", 3, Pins("B2"),  IOStandard("LVCMOS33")), # Bank 2 Green.
    ("user_led_n", 4, Pins("H15"), IOStandard("LVCMOS33")), # Bank 2 Green.
    ("user_led_n", 5, Pins("H14"), IOStandard("LVCMOS33")), # Bank 2 Green.
    ("user_led_n", 6, Pins("H12"), IOStandard("LVCMOS33")), # Bank 2 Green.
    ("user_led_n", 7, Pins("J15"), IOStandard("LVCMOS33")), # Bank 2 Green.

    ("seven_seg_n", 0, Pins("G16 G14 G12 G11 E12 E10 E9 F9"), IOStandard("LVCMOS33")),
